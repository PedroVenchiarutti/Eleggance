    ...
    <div className="container-task-bar">
      <div className="columns-task-bar">
        <div className="b">
          ...
          <img src="\icons\iconmonstr-delivery-1-96.png" alt="ImgIconeFrete" />
          </div>
          <ul>
            <li>
        ...
        <div className="b">
          <div className="icon-task-bar">
          <img src="\icons\icone-credit-card.png" alt="ImgIconeCard" />
          </div>
          <ul>
            <li>
            <div className="h4-titulo">
        ...
        <div className="b">
          <div className="icon-task-bar">
          <img src="\icons\icon-boleto.png" alt="ImgIconeCard" />
          </div>
          <ul>
            <li>
            <div className="h4-titulo">
        ...
        <div className="b">
          <div className="icon-task-bar">
          <img src="\icons\icon-lock.png" alt="ImgIconeCard" />
          </div>
          <ul>
            <li>
            <div className="h4-titulo">
